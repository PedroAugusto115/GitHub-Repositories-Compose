...
@Composable
internal fun PullRequestEmpty(modifier: Modifier = Modifier) {
    Column(
        modifier = modifier
            .fillMaxSize()
            .padding(horizontal = SpacingM)
            .testTag("pulls_empty_root"),
        ...
        Text(
            ...
            text = "There are no Pull Requests to display"
        )
    }
}
...
@Composable
private fun PullRequestEmptyPreview() {
    GitHubReposTheme {
